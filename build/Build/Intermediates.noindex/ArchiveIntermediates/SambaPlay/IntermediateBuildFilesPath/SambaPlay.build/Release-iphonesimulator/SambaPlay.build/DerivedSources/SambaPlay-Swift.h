...
#ifndef SAMBAPLAY_SWIFT_H
#define SAMBAPLAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SambaPlay",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SambaPlay11AppDelegate")
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC9SambaPlay27AudioSettingsViewController")
...
SWIFT_CLASS_NAMED("FavoriteDirectory")
@interface FavoriteDirectory : NSManagedObject
...
@class NSData;
SWIFT_CLASS_NAMED("FolderHistory")
@interface FolderHistory : NSManagedObject
@property (nonatomic, copy) NSString * _Nonnull folderPath;
@property (nonatomic, copy) NSString * _Nonnull displayName;
@property (nonatomic, copy) NSDate * _Nonnull lastAccessed;
@property (nonatomic) int32_t accessCount;
@property (nonatomic, copy) NSData * _Nullable bookmarkData;
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9SambaPlay27FolderHistoryViewController")
@interface FolderHistoryViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
@interface FolderHistoryViewController (SWIFT_EXTENSION(SambaPlay)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC9SambaPlay18MainViewController")
...
@class NSURL;
@interface MainViewController (SWIFT_EXTENSION(SambaPlay)) <UIDocumentPickerDelegate>
...
@interface MainViewController (SWIFT_EXTENSION(SambaPlay)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC9SambaPlay24NowPlayingViewController")
...
SWIFT_CLASS_NAMED("PlaybackPosition")
@interface PlaybackPosition : NSManagedObject
@property (nonatomic, copy) NSString * _Nonnull fileIdentifier;
@property (nonatomic, copy) NSString * _Nonnull fileName;
@property (nonatomic, copy) NSString * _Nonnull filePath;
@property (nonatomic, copy) NSString * _Nonnull serverName;
@property (nonatomic) double position;
@property (nonatomic) double duration;
@property (nonatomic, copy) NSDate * _Nonnull lastPlayed;
@property (nonatomic) float speed;
@property (nonatomic) float pitch;
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS_NAMED("SambaServer")
@interface SambaServer : NSManagedObject
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC9SambaPlay13SceneDelegate")
...
SWIFT_CLASS("_TtC9SambaPlay30ServerManagementViewController")
@interface ServerManagementViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end

@interface ServerManagementViewController (SWIFT_EXTENSION(SambaPlay)) <UIDocumentPickerDelegate>
- (void)documentPicker:(UIDocumentPickerViewController * _Nonnull)controller didPickDocumentsAtURLs:(NSArray<NSURL *> * _Nonnull)urls;
@end

@interface ServerManagementViewController (SWIFT_EXTENSION(SambaPlay)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)tableView:(UITableView * _Nonnull)tableView titleForHeaderInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC9SambaPlay17SimpleAudioPlayer")
@interface SimpleAudioPlayer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9SambaPlay24TextViewerViewController")
...
SWIFT_CLASS("_TtC9SambaPlay14ViewController")
